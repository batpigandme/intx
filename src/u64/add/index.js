...
/**
 * 64-bit unsigned integer addition: (a + b) mod 2^64.
 * Writes high 32 bits into out[0] and low 32 bits into out[1].
 *
 * Uses branchless hardware full-adder carry-out bit extraction:
