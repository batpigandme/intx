...
import f16x2icstrided from '#src/umul32dw/strided/split16x2imulc.js';
...
bench(bstdlib, "stdlib/umuldw.assign");
bench(b16x2icstrided, "16x2ic/strided");
...
function b16x2icstrided(n) {
  r[1] = 1;
  for (let i = 0; i < n; i++) {
    f16x2icstrided(r[1], a, r, 1, 0);
  }
  return r;
}