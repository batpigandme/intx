...
// (no #microbe/cycles: not loaded, the suite call is removed)
...
// scratch copy: the cycles suite call is replaced by an export; nothing else changed
module.exports = { runners: ops, iters: 100000000 };
