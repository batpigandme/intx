...
// scratch copy: no #microbe/cycles, stock wall-clock harness only
...
const first = Object.keys(ops)[0]; const v = ops[first]; delete ops[first]; ops[first + " [moved last]"] = v;
const res = bench.suite("Exp 6 [scratch b: stock wall-clock, row 1 moved last]", ops, {
	dur: 10, // what the fallback derives from cycles: 1e7
	width: 100,
	// mode: "sequential",
	// mode: "shuffled",
	rounds: 1e3,
